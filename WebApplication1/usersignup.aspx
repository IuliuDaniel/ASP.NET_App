<%@ Page Title="" Language="C#" MasterPageFile="~/masterPage.Master" AutoEventWireup="true" CodeBehind="usersignup.aspx.cs" Inherits="WebApplication1.usersignup" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <!-- Register pannel is in this container -->
<div class="container">
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <!-- Fifth row, has log-in data -->
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label>Username</label>
                            <div class="form-group">
                                <asp:TextBox CssClass="form-control" ID="TextBox8" placeholder="Username" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label for="TextBox2">Password</label>
                            <div class="form-group">
                                <asp:TextBox CssClass="form-control" ID="TextBox9" placeholder="Password" TextMode="Password" runat="server"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <asp:Button ID="Button1" runat="server" Text="Sign Up" CssClass="btn btn-primary btn-block" OnClick="Button1_Click" />
                            </div>
                        </div>
                    </div>
                </div>
